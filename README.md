...
대화형 생성 인공지능(Generative AI) 챗GPT(ChatGPT)의 오픈AI CEO __샘 알트만(Sam Altman)__는 인공지능 기술이 우리가 알고 있는 사회를 재구성할 것이라며, 실제 위험이 따르지만 우리의 삶을 획기적으로 개선하기 위해 "인류가 지금까지 개발한 가장 위대한 기술"이 될 수도 있다고 믿는다고 17일(현지시간) ABC방송 인터뷰를 통해 밝혔다.
...
깃헙을 배우면서 매우 재미있는 시간이었다. 그리고 협업을 하려면 꼭 필요하다는 것을 알게 되었다.
